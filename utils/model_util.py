...
def load_split_mdm(model, state_dict, cutting_point):   # from ComMDM
    new_state_dict = {}
    ...
    for k, v in state_dict.items():
        if k.startswith(orig_trans_prefix):
            ...
            target_split = 'seqTransEncoder_beginning.' if orig_layer < cutting_point else 'seqTransEncoder_end.'
